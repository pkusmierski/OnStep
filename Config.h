...
#define LED_RETICLE                   30 //    OFF, n. Where n=0..255 (0..100%) activates feature sets default brightness.   Option
...
#define AXIS1_STEPS_PER_DEGREE    6933.3 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS2_STEPS_PER_DEGREE    3466.6 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS4_SLEW_RATE_DESIRED       100 //    500, n, Where n=200..5000 (um/s.) Max microns/second. In DC mode, max pwr %   Adjust
//#define AXIS4_STEP_RATE_MAX         100
...
#define AXIS5_STEPS_PER_MICRON        10 //    0.5, n. Steps per micrometer. Figure this out by testing or other means.      Adjust
#define AXIS5_SLEW_RATE_DESIRED       100 //    500, n, Where n=200..5000 (um/s.) Max microns/second. In DC mode, max pwr %   Adjust
...
#define AXIS5_DRIVER_DC_MODE          ON //    OFF, DRV8825 for pwm dc motor control on stepper driver outputs.              Option
